...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <a href="{{ route('order') }}" class="ms-2 me-5 flex items-center space-x-2 rtl:space-x-reverse lg:ms-0"
            wire:navigate>
            <x-app-logo />
        </a>
        ...
        <livewire:components.database-notification-menu />
@endauth
        <!-- Desktop User Menu -->
        @auth
        <flux:dropdown position="top" align="end">
            ...
            <flux:menu>
                ...
                <flux:menu.separator />
                <flux:menu.radio.group>
                    <flux:menu.item icon="gift" :href="route('gift-cards.send')"
                        :current="request()->routeIs('gift-cards.send')" wire:navigate>{{ __('Send Gift Card') }}
                    </flux:menu.item>
                    <flux:menu.item icon="gift" :href="route('gift-cards.redeem')"
                        :current="request()->routeIs('gift-cards.redeem')" wire:navigate>{{ __('Redeem Gift Card') }}
                    </flux:menu.item>
                </flux:menu.radio.group>
