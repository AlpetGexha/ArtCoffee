            ...
            <div class="lg:flex lg:items-center lg:space-x-12">
                <div class="lg:w-1/2">
                    ...
                    <div class="mt-10 flex items-center space-x-6">
                        <a href="#menu" class="bg-amber-600 text-white px-8 py-4 rounded-full font-medium hover:bg-amber-700 transition-colors">
                            Shiko Menynë
                        </a>
                        <div class="w-32 h-32 bg-white p-3 rounded-xl shadow-lg">
                            <img src="/qr-code.png" alt="Skano për të Porositur" class="w-full h-full">
                        </div>
                    </div>
                </div>
