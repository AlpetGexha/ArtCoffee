    ...
    private function seedCoffeeProducts(): void
    {
        ...
        foreach ($coffees as $coffee) {
            $product = Product::create([
                ...
                'image_path' => 'products/coffee/' . Str::slug($coffee['name']) . '.jpg',
    ...
    private function seedTeaProducts(): void
    {
        ...
        foreach ($teas as $tea) {
            $product = Product::create([
                ...
                'image_path' => 'products/tea/' . Str::slug($tea['name']) . '.jpg',
                'is_customizable' => true,
                'is_available' => true,
    ...
    private function seedPastryProducts(): void
    {
        ...
        foreach ($pastries as $pastry) {
            Product::create([
                ...
                'image_path' => 'products/pastry/' . Str::slug($pastry['name']) . '.jpg',
    ...
    private function seedSnackProducts(): void
    {
        ...
        foreach ($snacks as $snack) {
            Product::create([
                ...
                'image_path' => 'products/snack/' . Str::slug($snack['name']) . '.jpg',
                'is_customizable' => false,
                'is_available' => true,
    ...
    private function seedMerchandiseProducts(): void
    {
        ...
        foreach ($merchandise as $item) {
            Product::create([
                ...
                'image_path' => 'products/merchandise/' . Str::slug($item['name']) . '.jpg',
                'is_customizable' => false,
                'is_available' => true,
                'preparation_time_minutes' => 0,
                'ingredients' => null,
